...
#
"""
Emmet/Ace set NDP probe enabled example.
"""
...
def _main():
    ...
    group.add_argument("--enable", "-e", action="store_true",
                       help="Enable NDP probe support")
    group.add_argument("--disable", "-d", action="store_true",
                       help="Disable NDP probe support")
    ...
    dutif.exec("wlan/set_ndp_probe_enabled", ndp_probe_enabled=args.enable)
    if args.enable:
        print("NDP probe support enabled")
    else:
        print("NDP probe support disabled")
