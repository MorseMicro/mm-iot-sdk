                                         ...
                                         struct mmbuf *commandbuffer)
{
    ...
    case mmagic_wlan_var_sta_evt_en:
        return mmagic_m2m_create_response(mmagic_wlan, mmagic_wlan_cmd_get, subcommand,
                                          MMAGIC_STATUS_OK, &data->config.sta_evt_en,
                                          sizeof(data->config.sta_evt_en));

    case mmagic_wlan_var_duty_cycle_mode:
        return mmagic_m2m_create_response(mmagic_wlan, mmagic_wlan_cmd_get, subcommand,
                                          MMAGIC_STATUS_OK, &data->config.duty_cycle_mode,
                                                    ...
                                                    struct mmbuf *commandbuffer)
{
    ...
    return mmagic_m2m_create_response(mmagic_wlan, mmagic_wlan_cmd_get_sta_status,
                                      subcommand, status, &rsp_args, sizeof(rsp_args));
}
