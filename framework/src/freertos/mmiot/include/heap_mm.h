...
void *pvPortRealloc_dbg( void *pv, size_t xWantedSize, const char *function, unsigned linenum ) PRIVILEGED_FUNCTION;
void vPortFree_dbg( void *pv ) PRIVILEGED_FUNCTION;

#define pvPortMalloc_(xSize) pvPortMalloc_dbg((xSize), __FUNCTION__, __LINE__)
#define pvPortRealloc_(pv, xSize) pvPortRealloc_dbg((pv), (xSize), __FUNCTION__, __LINE__)
